package com.xhwl.xhwlownerapp.UIUtils.CircleUIUtil;
...
public class UpCircleMenuLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            //child.layout(0, top, left + cWidth, top + cWidth);
            // 叠加尺寸
    ...
    private void addMenuItems() {
        ...
        for (int i = 0; i < mMenuItemCount; i++) {
            ...
            LinearLayout linearLayout = (LinearLayout) view
                    .findViewById(R.id.id_circle_menu_item_liner);
            if (iv != null) {
            ...
            if (tv != null) {
                ...
                iv.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        //mOnMenuItemClickListener.itemClick(j);
                    }
                });
            }
                ...
                linearLayout.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (mOnMenuItemClickListener != null) {
                            mOnMenuItemClickListener.itemCenterClick(view,j);
                        }
                    }
                });
            }
