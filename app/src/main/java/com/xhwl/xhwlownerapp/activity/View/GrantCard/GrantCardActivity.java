 ...
 * 授权门卡
 */
public class GrantCardActivity extends BaseActivity implements View.OnClickListener {

    private AutoLinearLayout mWebviewTopBack;
    /**  */
    private TextView mWebviewTopTitle;
    private ImageView mWebviewTopRecord;
    private WebView mDoorCardManager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grant_card);
        initView();
    }

    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private void initView() {
        userName  = SPUtils.get(GrantCardActivity.this,"userName","");
        projectCode  = SPUtils.get(GrantCardActivity.this,"proCode","");
        granterPhone  = SPUtils.get(GrantCardActivity.this,"userTelephone","");
        proName  = SPUtils.get(GrantCardActivity.this,"proName","");
    ...
    public String setUrl(String userName, String projectCode, String granterPhone) {
        ...
        String url = "https://yq.xhmind.com:8093/#/authorization/?projectCode=" + projectCode + "&userName=" + userName + "&granterPhone=" + granterPhone;
        return url;
    }
